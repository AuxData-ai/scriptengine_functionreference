...
| ------ | ------ | ------ |
| agentId | number |der agent, der verwendet werden soll um mit seiner Konfiguration Dateien auszulesen. Relevant sind die Konfigurationen der WissensDb, wie die konfigurierten Modelle für ComputerVision und Spracherkennung.|
