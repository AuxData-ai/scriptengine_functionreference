...
<table>
<tr>
<th>Name der Umgebungsvariable</th>
<th>Typ</th>
<th>Bedeutung</th>
</tr>
<tr>
...
Hier kann der timeout einer Funktion überschrieben werden. Der Wert wird als Sekunden übergeben. überschreitet die Dauer der Ausführung einer Funktion diesen Wert in Sekunden, so wird die Funktion abgebrochen. Wird dieser Wert nicht gesetzt, so wird der interne Wert von 600 Sekunden (10 Minuten) verwendet.
